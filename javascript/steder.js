...
var hytter = [
  ...
  [L.latLng(60.536944, 6.079167), "bergsdalen", "Alexander Grieghytten", "img/alexgrieg.jpg", "Området rundt Alexander Grieghytten har en rekke turmuligheter. Hamlagrøhornet og Krampane nord for hytten, og Kjerringafjellet og Storliknausen sør for hytten, er alle flotte toppturmål. Førstnevnte er mye benyttet som utflukt for de de yngste turgåerne (barneskolealder). Vinterstid er det lett og fint skiterreng fra Hamlagrøosen og sørover mot Fugladalen.", 1, 600, "<p>Ubetjent hele året.</p><p>Må låne nøkkel.</p><p>34 sengeplasser.</p>"],
